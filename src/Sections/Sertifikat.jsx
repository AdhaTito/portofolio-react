    ...
    return (
        <>
            <section id="sertifikat">
                <div className="container pt-32 pb-28">
                    ...
                    <div className="flex flex-wrap px-4 ">
                        <div
                            id="default-carousel"
                            className="relative w-96 md:w-[600px] mx-auto "
                            data-carousel="slide"
                        >
                            <div className="relative h-72 overflow-hidden rounded-xl md:h-[400px] shadow-lg">
                                <div
                            ...
                            <div className="absolute z-30 flex p-1 space-x-3 -translate-x-1/2 bottom-5 left-1/2 rtl:space-x-reverse">
                                <button
                                    type="button"
                            ...
                            <button
                                ...
                                data-carousel-prev
                            >
                                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-slate-400 dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                    <svg
